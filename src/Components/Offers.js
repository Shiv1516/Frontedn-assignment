...
//       <div className="offers-cards df fww ptb24">
//         <div className="offers-card flx33">
//           <div className="offers-inner-card mlr16 brd2 br12 pr pt40 pb32 plr24">
//             <img
//               src="images\offer-icon.png"
//               alt="offer-icon"
//               className="offer-image p16 br12 bg2 h48 pa r0 mr32"
//             />
//             <h3 className="offers-card-head fs20 fw5 mb24">
//               <span className="brd3 mr12"></span> Apply Coupans
//             </h3>
//             <h4 className="offers-card-heading fs15 lh24 mb24">
//               Use the code <span className="fs16 fc2 fw6">NEWLYLAUNCHED</span>{" "}
//               on our recently launched vistas, and get a flat 15% off, up to Rs.
//               3,000.
//             </h4>
