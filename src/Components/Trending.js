...
//       <h2 className="section-heading ptb16 fs36 fc2 fw7 tac">
//         Trending This Season
//       </h2>
//       <div className="trending-cards df fww ptb32">
//         <div className="trending-card flx25">
//           <div className="trending-inner-card mlr12 cp">
//             <img
//               src="images\trending.jpg"
//               alt="trending"
//               className="trending-image mb16 w100 br12"
//             />
//             <div className="trending-detail ml8">
//               <h3 className="trending-card-heading fs18 fw6 mb12">
//                 Parc Buttes-Chaumount
//               </h3>
...
//                 $ 379 <span className="fs12 fc4">/Person</span>
//               </p>
//             </div>
//           </div>
//         </div>
...
function Trending() {
  ...
  return (
    <div className="trending-section wrapper ptb48">
      <h2 className="section-heading ptb24 fs36 fc2 fw7 tac">
        Trending This Season
      </h2>
      <Slider {...settings}>
